...
**질문** 
Q.Attention Score와 Attention Weight를 통해 모델의 결정 과정을 해석할 수 있는데,  Attention Score가 높은 요소가 실제로 중요한 요소임을 보장할 수 없는 사례가 있다면, 이를 어떻게 설명할 수 있을까? (Attention Score가 높은 요소가 실제로 중요한 요소가 아니라면?!)
